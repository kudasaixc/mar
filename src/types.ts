...
export type RuntimeEvent =
  ...
  | { type: "agent:tool-result"; agent: string; tool: string; ok: boolean; preview: string }
  | { type: "agent:fallback"; agent: string; model: string; error: string }
  | { type: "agent:end"; agent: string; turns: number };
